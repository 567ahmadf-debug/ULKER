          ...
          <div className="flex items-center gap-4 flex-wrap">
            ...
            <div className="flex items-center gap-1.5">
              {weightFilters.map((w) => (
                <button
                  ...
                  data-testid={`chip-weight-${w.toLowerCase().replace(/[^a-z0-9]/g, "-")}`}
            ...
            {hasFilters && (
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold text-destructive hover:text-destructive/80 border border-destructive/30 hover:border-destructive/50 transition-all"
              >
                <X size={12} />
                {t("filters.clear_all")}
              </button>
